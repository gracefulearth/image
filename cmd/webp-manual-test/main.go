...
// This build tag means that "go install github.com/gracefulearth/image/..." doesn't
...
package main // import "github.com/gracefulearth/image/cmd/webp-manual-test"
...
import (
	...
	"github.com/gracefulearth/image/webp"
)
