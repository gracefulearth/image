...
go test github.com/gracefulearth/image/font/sfnt -args -proprietary
...
go test github.com/gracefulearth/image/font/sfnt -test.run=ProprietaryMicrosoft -args -proprietary etc
*/
